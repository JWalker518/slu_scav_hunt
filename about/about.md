# Hunt
## Problem
I want a unique SLU experience where people can work together to solve a series of problems/riddles that a user created in an ARG (Alternate Reality Game).  I want the users to be able to leave a riddle, and for other users to be able to solve the puzzle and be rewarded.
